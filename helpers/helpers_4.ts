import { ADMIN, ADMIN_OWNER, MODERATOR, SUPER_ADMIN, USER } from '@/data/stepConstants';
import { getPreviousDay } from './helpers_2';
...
export function isInSelectedDate(
  ...
  const endDate = getPreviousDay(new Date(endDateString));
